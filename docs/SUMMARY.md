...
* Sharing boasis.ae on WhatsApp, X or Facebook shows one clean image: the exact BOASIS logo in white, on the same background the site itself uses — deep navy with the blue light on the right, the site's own gradient and glow, not a flat colour.
